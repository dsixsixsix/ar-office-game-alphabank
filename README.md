...
`admin_create_department`, `admin_rename_department` для администратора. Роль проверяется на сервере.
...
admin/          админка: выдача доступов и департаменты
native/
...
департаменты и админка для выдачи доступов. Работают сканирование QR-кодов, вход и выход из офиса по
