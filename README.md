...
Альфа-Банка. В ней два раздела: «Доступ» и «Статистика». Все данные приходят через админские RPC,
панель ничего не меняет в обход сервера.

<p align="center">
  <img src="docs/screenshots/admin-01-login.png" width="720" alt="Вход администратора">
</p>
...
<table>
  <tr>
    <td align="center"><img src="docs/screenshots/admin-02-access.png" width="420"><br>Выдача доступа и список игроков</td>
    <td align="center"><img src="docs/screenshots/admin-03-dropdown.png" width="420"><br>Выбор департамента</td>
  </tr>
</table>
...
текущая и лучшая серия дней, дней в офисе, выполненные задания, заработанные коины, баланс и время
последней активности. Сверху счётчики «сейчас в офисе» и «были сегодня». Есть поиск по имени и
логину, фильтр по департаменту и сортировка (новые, активность, серия, дни в офисе, задания, коины).

<p align="center">
  <img src="docs/screenshots/admin-04-stats.png" width="720" alt="Статистика игроков">
</p>
...
- **Карточка:** логин, департамент, дата создания аккаунта, первый игровой день, последняя активность,
  ...
  коллеги, заработанные коины и баланс.
...
- **По дням:** для каждого рабочего дня время входа и выхода, выполненные задания со временем и
  наградой, пропущенные и ждущие подтверждения задания, коллеги, покупки и коины за день.
- **Журнал действий:** все события по времени: входы в игру и в офис, выходы, коды комнат, задания,
  встречи, ответы на фото, награды, покупки, штрафы, билеты розыгрыша. Есть фильтр по типу.
...
<table>
  <tr>
    <td align="center"><img src="docs/screenshots/admin-05-player.png" width="420"><br>Карточка и посещаемость</td>
    <td align="center"><img src="docs/screenshots/admin-06-days.png" width="420"><br>История по дням</td>
  </tr>
  <tr>
    <td align="center"><img src="docs/screenshots/admin-07-journal.png" width="420"><br>Журнал действий</td>
    <td align="center"><img src="docs/screenshots/admin-08-coins.png" width="420"><br>Монеты</td>
  </tr>
  <tr>
    <td align="center" colspan="2"><img src="docs/screenshots/admin-09-fraud.png" width="420"><br>Антифрод</td>
  </tr>
</table>
...
F8, F10, коды входа и выхода в эмуляторе камеры и тур работают через dev-RPC: сервер должен быть
...
департаменты и админка для выдачи доступов, статистики и аудита активности игроков. Работают сканирование QR-кодов, вход и выход из офиса по
